...
const fish = [
  { id: 1, name: 'Flat Head (Ploščata Glava)', species: 'Triglidae', model: flatHead },
  { id: 2, name: 'Common Cuttle Fish(Navadna Sipa)', species: 'Sepia officinalis', model: commoncuttlefish },
  { id: 3, name: 'Pisanica(pisanica)', species: 'Labridae', model: pisanica },
]
